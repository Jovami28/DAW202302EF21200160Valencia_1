      ...
      <div class="form">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="date" v-model="DateOfBirth" placeholder="yyyy/mm/dd" required>
          </div>
          <div class="input-box">
        ...
        <div class="button" @click="register">
          <input type="text" :value="'Registro'">
        </div>
      </div>
    </div>
  </div>
...
.container {
  max-width: 700px;
  width: 100%;
  background-color: rgb(188, 187, 143);
  padding: 25px 30px;
  border-radius: 5px;
...
.user-details .input-box input {
  ...
  border-radius: 5px;
  padding-left: 15px;
  border: 1px solid rgb(255, 243, 240);
...
export default {
  ...
  methods: {
    register() {
      ...
      let url = "https://storedb-api.onrender.com/users"
      var data = {
